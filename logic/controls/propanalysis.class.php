...
class propanalysis{
	...
	public function getprop() {
		...
		$listsql = "select p_plat,p_sever,p_name,sum(p_num) num,sum(p_money) money from prop_list where createtime >= '".$startdate."' and createtime <='".$enddate."' group by p_name order by num ";//limit ".intval($page->getOff()).",".intval($this->pageSize);
